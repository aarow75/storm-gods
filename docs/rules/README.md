...
- **I-introduction.md** — Background, setting, and world context
- **II-character-creation.md** — How to create an adventurer (characteristics, abilities, skills, equipment)
- **III-mechanics-and-melee.md** — Core game mechanics (time, movement, encumbrance, combat)
- **IV-combat-skills.md** — Detailed combat mechanics (parries, critical/fumbled, weapons, armor)
- **V-basic-magic.md** — Battle magic and spirit combat
- **VI-other-skills.md** — Non-combat professions and guilds
...
- Rules are based on RQ2/3 as documented on the official wiki
- Where the current app implementation differs from these rules, discrepancies are noted for future review
- This documentation will serve as the source of truth for identifying incomplete or incorrect mechanics
